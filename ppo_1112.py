...
def get_reward(state, action):
    ...
    obs_dis= traj_rect_dist(cond_traj.T,  limit , alif)  #new distance
    # orig_obs= traj_rect_dist(mean_margs.T,  limit,alif) #old distance
    ...
    reward =    alif*obs_dis - (1-alif)*fid_cost
